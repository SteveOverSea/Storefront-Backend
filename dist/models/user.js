        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new book " + u.first_name + " " + u.last_name + " . Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Users.prototype.update = function (id, u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE users SET first_name=$1, last_name=$2, password=$3 WHERE id=" + id + " RETURNING *;";
                        return [4 /*yield*/, conn
                                .query(sql, [u.first_name, u.last_name, u.password])];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update user " + u.id + ". Error: " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
